...
class TrailItems(Base):
    ...
    section_id: Mapped[Optional[int]] = mapped_column(ForeignKey("trail_sections.id", ondelete="SET NULL"))
    item_type_id: Mapped[Optional[int]] = mapped_column(ForeignKey("lk_item_type.id"), nullable=True)
